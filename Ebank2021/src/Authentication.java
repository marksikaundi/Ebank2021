...
/**
*
* @author Mark Sikaundi(thewizard)
*/
	...
	public Authentication() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					String s1 = "marksikaundi_user";
					String a1 = textField.getText();
					
					String s2 = "@sikaundi21";
		...
		JLabel lblCopyrightscThedeepanshumourya = new JLabel("Copyrights(c) MarkSikaundi 2021.");
